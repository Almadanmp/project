...
public class SensorList_Test {
    ...
    public void seeIfGetMostRecentlyUsedSensorWorks() {
        ...
        Sensor s1 = new Sensor("Vento", new TypeSensor("Atmosphere"), new Local(12, 31, 21), new Date(), l1);
        Sensor s2 = new Sensor("Chuva", new TypeSensor("Atmosphere"), new Local(10, 30, 20), new Date(), l2);
