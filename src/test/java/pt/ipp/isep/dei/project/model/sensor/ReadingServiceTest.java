...
class ReadingServiceTest {
    ...
    void seeIfAddHouseReadingToRepositoryWorksWhenSensorDoesNotExist() {
        ...
        boolean actualResult = readingService.addHouseReadingToRepository(sensorId, 20D, validDate1, "C", logger, houseSensorService);
    ...
    void seeIfAddHouseReadingToRepositoryWorksWhenSensorWasNotActiveDuringRead() {
        ...
        boolean actualResult = readingService.addHouseReadingToRepository(sensorId, 20D, validDate2, "C", logger, houseSensorService);
    ...
    void seeIfAddHouseReadingToRepositoryWorksWhenReadingAlreadyExists() {
        ...
        boolean actualResult = readingService.addHouseReadingToRepository(sensorId, 2D, validDate1, "C", logger, houseSensorService);
