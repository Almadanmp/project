...
class GASettingsControllerTest {
    ...
    void seeIfCreatesGeographicAreaAndAddsItToList() {
        ...
        boolean result = controller.addNewGeoAreaToList(geoList, "Porto", typeCity, latitude, longitude, altitude, length, width);
    ...
    void seeIfCreatingExistingGeographicAreaFails() {
        ...
        boolean result1 = controller.addNewGeoAreaToList(geoList, name, typeCity, latitude, longitude, altitude, length, width);
        boolean result2 = controller.addNewGeoAreaToList(geoList, name, typeCity, latitude, longitude, altitude, length, width);
        geoList.addGeographicArea(geoFail);
        boolean result3 = controller.addNewGeoAreaToList(geoList, name, typeCity, latitude, longitude, altitude, length, width);
    ...
    void seeIfCreatesTwoDifferentGeographicAreas() {
        ...
        boolean result1 = controller.addNewGeoAreaToList(geoList, name1, typeCity, latitude, longitude, altitude, length, width);
        boolean result2 = controller.addNewGeoAreaToList(geoList, name2, typeCity, latitude, longitude, altitude, length, width);
