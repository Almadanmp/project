...
//    }
    ...
    void seeIfcategoryIIICalculusUS445Works() {
        ...
        // Act
        boolean actualResult = geographicAreaService.categoryIIICalculusUS445(validReading, 0);
        // Assert
        assertTrue(actualResult);
    }
    ...
    void seeIfcategoryIIICalculusUS445FailsBoundaryValue() {
        ...
        // Act
        boolean actualResult = geographicAreaService.categoryIIICalculusUS445(validReading, result);
    ...
    void seeIfcategoryIIICalculusUS445Fails() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIIICalculusUS445(validReading, 20);
        // Assert
        assertFalse(actualResult);
    }
    ...
    void seeIfcategoryIICalculusUS445Works() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIICalculusUS445(validReading, 0);
        // Assert
        assertTrue(actualResult);
    }
    ...
    void seeIfcategoryIICalculusUS445Fails() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIICalculusUS445(validReading, 20);
        // Assert
        assertFalse(actualResult);
    }
    ...
    void seeIfcategoryICalculusUS445Works() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryICalculusUS445(validReading, 0);
        // Assert
        assertTrue(actualResult);
    }
    ...
    void seeIfcategoryICalculusUS445Fails() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryICalculusUS445(validReading, 20);
        // Assert
        assertFalse(actualResult);
    }
    ...
    void seeIfcategoryICalculusUS440Works() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryICalculusTemperaturesLowerThanAverage(validReading, 0);
        // Assert
        assertFalse(actualResult);
    }
    ...
    void seeIfcategoryICalculusUS440Fails() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryICalculusTemperaturesLowerThanAverage(validReading, 20);
        // Assert
        assertTrue(actualResult);
    }
    ...
    void seeIfcategoryIICalculusUS440Works() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIICalculusTemperaturesLowerThanAverage(validReading, 0);
        // Assert
        assertFalse(actualResult);
    }
    ...
    void seeIfcategoryIICalculusUS440Fails() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIICalculusTemperaturesLowerThanAverage(validReading, 30);
        // Assert
        assertTrue(actualResult);
    }
    ...
    void seeIfcategoryIIICalculusUS440Works() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIIICalculusTemperaturesLowerThanAverage(validReading, 0);
        // Assert
        assertFalse(actualResult);
    }
    ...
    void seeIfcategoryIIICalculusUS440Fails() {
        // Arrange
        // Act
        boolean actualResult = geographicAreaService.categoryIIICalculusTemperaturesLowerThanAverage(validReading, 40);
        // Assert
        assertTrue(actualResult);
    }
    ...
    void seeIfGetAverageReadingsBetweenDatesFailsEmptyReadingList() {
        ...
        // Act
        Double actualResult = geographicAreaService.getAverageReadingsBetweenFormattedDates(validDate2, validDate1, firstValidAreaSensor);
        // Assert
        assertEquals(expectedResult, actualResult);
    }
    ...
    void seeIfGetAverageReadingsBetweenDatesWorks() {
        ...
        // Act
        double actualResult = geographicAreaService.getAverageReadingsBetweenFormattedDates(initialTime, endingTime, validAreaSensor);
        // Assert
        assertEquals(expectedResult, actualResult);
    }
    ...
    void seeIfGetReadingsBetweenDatesWorks() {
        ...
        // Act
        List<Reading> actualResult = geographicAreaService.getReadingListBetweenFormattedDates(initialTime, endingTime, validAreaSensor);
        // Assert
