...
class HouseMonitoringControllerTest {
    ...
    void arrangeArtifacts() {
        ...
        GeographicAreaService geographicAreaService = new GeographicAreaService(geographicAreaRepository, areaTypeRepository, sensorTypeRepository);
        ...
        RoomService roomService = new RoomService(roomRepository, roomSensorRepository, sensorTypeRepository);
        ...
        try {
            ...
            Date validDate03 = validSdf.parse("25/06/2017 10:00:00");
            Date validDate04 = validSdf.parse("02/10/2017 15:30:00");
            Date validDate05 = validSdf.parse("13/12/2017 01:02:00");
            validDate06 = validSdf.parse("02/01/2018 22:00:00");
            Date validDate07 = validSdf.parse("09/07/2018 12:20:00");
            Date validDate08 = validSdf.parse("02/08/2018 08:00:00");
            Date validDate09 = validSdf.parse("05/02/2019 01:15:00");
            ...
            Date validDate23 = validSdf.parse("06/02/2020 18:00:00");
        ...
        RoomSensor validTemperatureRoomSensor = new RoomSensor("T123", "TempOne", new SensorType("temperature", "Celsius"),
                new Date(), "RoomAB");
        ...
        */
        ...
        RoomDTO validRoomDTO = RoomMapper.objectToDTO(validRoom1);
    }
