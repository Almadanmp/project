...
public class AreaSensor {
    ...
    static List<AreaSensor> getAreaSensorsOfGivenType(List<AreaSensor> areaSensors, String sensorType) {
     ...
     **/
    static AreaSensor getMostRecentlyUsedAreaSensor(List<AreaSensor> startList) {
        if (startList.isEmpty()) {
            throw new IllegalArgumentException("The sensor list is empty.");
        }
        List<AreaSensor> areaSensorsWithReadings = AreaSensor.getAreaSensorsWithReadings(startList);
