...
public class SensorService {
    ...
    /**
     * Method to addWithoutPersisting a reading to a matching sensor contained in the repository. The sensor is found by its ID.
     *
     * @param sensorList   is the sensorList we want to addWithoutPersisting a reading to.
     * @param sensorID     is the ID of the sensor we want to addWithoutPersisting a reading to.
