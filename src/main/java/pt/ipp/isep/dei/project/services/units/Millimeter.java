...
public class Millimeter implements RainfallUnit {


    /**
     * This method checks the application default rainfall unit and then converts a Millimeter value into the default one.
     *
    ...
    /**
     * This method checks the user default rainfall unit and then converts a Millimeter value into the default one.
     *
     * @param valueToConvert refers to the rainfall value.
     * @return value converted into the default Unit.
     * @throws IOException in case the properties file is missing or doesn't have the property.
     ...
     *
     * @param volume refers to the rainfall in Millimeter.
