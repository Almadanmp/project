        ...
        return (
          <div>
            ...
            <Collapse isOpen={this.state.collapse}>
                  ...
                  <h5 key={amplitude.value}> {amplitude.toString().indexOf("ERROR") != 0 ? 'There is no data available' : 'The highest amplitude was' + amplitude.value +'on the date'+ amplitude.date + 'ºC'}</h5>
